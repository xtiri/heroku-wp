...
class ProductListSimple implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
	    if(function_exists('vc_map')) {
		    vc_map(
		    	array(
				    'name'                      => esc_html__( 'Edge Product List - Simple', 'fluid' ),
				    'base'                      => $this->base,
				    ...
				    'params'                    => array(
					    array(
						    ...
						    'value'      => array(
							    esc_html__( 'Sale', 'fluid' )         => 'sale',
							    esc_html__( 'Best Sellers', 'fluid' ) => 'best-sellers',
							    esc_html__( 'Featured', 'fluid' )     => 'featured'
						    )
					    ),
					    array(
						    'type'        => 'textfield',
						    ...
						    'description' => esc_html__( 'Number of products to show (default value is 4)', 'fluid' )
					    ),
					    array(
						    'type'        => 'dropdown',
						    'param_name'  => 'order_by',
    ...
    public function render($atts, $content = null){
        ...
        $html = fluid_edge_get_woo_shortcode_module_template_part('templates/product-list-template', 'product-list-simple', '', $params);
