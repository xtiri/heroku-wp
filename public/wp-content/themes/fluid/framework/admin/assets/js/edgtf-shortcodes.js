				...
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[edgtf_inner_row_holder space_between_columns="' + e.data.space_between_columns + '" text_alignment="' + e.data.text_alignment + '"][edgtf_inner_row_column column_size="6"]Left column text content[/edgtf_inner_row_column][edgtf_inner_row_column column_size="6"]Right column text content[/edgtf_inner_row_column][/edgtf_inner_row_holder]');
							}
						});
					}
				},
