...
class FluidEdgeClassSimpleLineIcons implements iFluidEdgeInterfaceIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'fluid'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'fluid'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'fluid'),
            'icon-social-facebook'    => esc_html__('Facebook', 'fluid'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'fluid'),
            'icon-social-github'      => esc_html__('Github', 'fluid'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'fluid'),
            'icon-social-instagram'   => esc_html__('Instagram', 'fluid'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'fluid'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'fluid'),
            'icon-social-reddit'      => esc_html__('Reddit', 'fluid'),
            'icon-social-skype'       => esc_html__('Skype', 'fluid'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'fluid'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'fluid'),
            'icon-social-spotify'     => esc_html__('Spotify', 'fluid'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'fluid'),
            'icon-social-twitter'     => esc_html__('Twitter', 'fluid'),
            'icon-social-youtube'     => esc_html__('Youtube', 'fluid')
        );
    }
