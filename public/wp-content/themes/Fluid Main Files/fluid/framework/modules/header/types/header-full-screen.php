...
class HeaderFullScreen extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = fluid_edge_filter_px(fluid_edge_options()->getOptionValue('menu_area_height_header_full_screen'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('fluid_edge_filter_header_fullscreen_parameters', $parameters);
