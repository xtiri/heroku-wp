...
add_filter( 'wp_setup_nav_menu_item', 'fluid_edge_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'fluid_edge_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'fluid_edge_edit_walker', 10, 2 );

function fluid_edge_add_custom_nav_fields( $menu_item ) {
	...
	$menu_item->heading = get_post_meta( $menu_item->ID, '_menu_item_heading', true );
 ...
 * @return      void
*/
function fluid_edge_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
    $check = array('anchor', 'nolink', 'heading', 'hide', 'type_menu', 'icon', 'icon_pack', 'sidebar', 'wide_position', 'featured_icon');
 ...
 * @return      void
*/
function fluid_edge_edit_walker($walker,$menu_id) {
	return 'FluidEdgeClass_Walker_Nav_Menu_Edit_Custom';
}
...
include_once EDGE_ROOT_DIR.'/includes/nav-menu/vertical-compact-navigation-walker.php';